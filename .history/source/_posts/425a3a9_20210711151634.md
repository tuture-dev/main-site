...
photos:
  - https://static.powerformer.com/c/b9b4d831629e9a7df36131b1661569eb/cover-2.jpg
---
...
![](https://static.powerformer.com/c/b9b4d831629e9a7df36131b1661569eb/add-data-in-admin.jpg)

再运行前端页面，可以看到我们刚刚在 Django 后台管理中添加的项目：

![](https://static.powerformer.com/c/b9b4d831629e9a7df36131b1661569eb/recipe-list.jpg)
      ...
      <div class="col-md-4">
        ...
        <form @submit.prevent="submitRecipe">
          ...
          <div class="form-group">
            [tuture-add] <label for>Recipe Name</label> [tuture-add]
            <input type="text" class="form-control" v-model="recipe.name" />
            [tuture-add]
          </div>
          [tuture-add]
          <div class="form-group">
            [tuture-add] <label for>Ingredients</label> [tuture-add]
            <input
              type="text"
          ...
          [tuture-add]
          <div class="form-group">
            [tuture-add] <label for>Food picture</label> [tuture-add]
            <input type="file" @change="onFileChange" /> [tuture-add]
          </div>
          [tuture-add]
          <div class="row">
            [tuture-add]
            <div class="col-md-6">
              [tuture-add]
              <div class="form-group">
                [tuture-add] <label for>Difficulty</label> [tuture-add]
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                [tuture-add]
                <label for>
                  [tuture-add] Prep time [tuture-add]
                  <small>(minutes)</small> [tuture-add]
                </label>
                [tuture-add]
                <input
                  type="text"
          ...
          <div class="form-group mb-3">
            [tuture-add] <label for>Preparation guide</label> [tuture-add]
            <textarea
...
![](https://static.powerformer.com/c/b9b4d831629e9a7df36131b1661569eb/recipe-detail.jpg)
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <form @submit.prevent="submitRecipe">
          [tuture-add]
          <div class="form-group">
            [tuture-add] <label for>食谱名称</label> [tuture-add]
            <input type="text" class="form-control" v-model="recipe.name" />
            [tuture-add]
          </div>
          [tuture-add]
          <div class="form-group">
            [tuture-add] <label for>食材</label> [tuture-add]
            <input
              v-model="recipe.ingredients"
              type="text"
              class="form-control"
          ...
          [tuture-add]
          <div class="form-group">
            [tuture-add] <label for>图片</label> [tuture-add]
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              [tuture-add]
              <div class="form-group">
                [tuture-add] <label for>难度</label> [tuture-add]
                <select v-model="recipe.difficulty" class="form-control">
                  [tuture-add]
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                [tuture-add]
                <label for>
                  [tuture-add] 制作时间 [tuture-add]
                  <small>(分钟)</small> [tuture-add]
                </label>
                [tuture-add]
                <input
                  v-model="recipe.prep_time"
          ...
          [tuture-add]
          <div class="form-group mb-3">
            [tuture-add] <label for>制作指南</label> [tuture-add]
            <textarea
              v-model="recipe.prep_guide"
              class="form-control"
              rows="8"
...
![](https://static.powerformer.com/c/b9b4d831629e9a7df36131b1661569eb/add-recipe.jpg)
